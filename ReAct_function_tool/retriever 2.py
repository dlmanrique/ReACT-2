import os
from linguo.vector_db import PostgreSQLDB
...
class Retriever:
    ...
    def __init__(self, k: int, enabled_reranker: bool = False) -> None:
        ...
        self.vector_db = PostgreSQLDB(
            host="question-solver-test.c8tj9at79njz.us-east-1.rds.amazonaws.com",
            port="5432",
            database="qs",
            user="qs",
            password="questionsolver123"
        )
